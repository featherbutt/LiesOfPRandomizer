...
using static LiesOfPRandomzier.ItemPriorityMethods;
...
namespace LiesOfPRandomzier
{
    ...
    public class MapItemLocation : ItemLocation
    {
        ...
        bool ItemLocation.canHoldWeapon
        {
            get
            {
                return true;
        ...
        public MapItemLocation(ItemLocations locations, StructProperty itemPackage)
        {
            ...
            {
                this.priority = locations.config.items.getItemPriority(weaponName.Value.ToString());
            } else if (itemName.Value != null)
            {
                this.priority = locations.config.items.getItemPriority(itemName.Value);
            } else
            {
        ...
        public FName name
        {
            set
            {
                if (GameData.IsWeaponHandle(value.ToString())) {
                    ...
                    itemPackage.getNameProperty("_weapon_item_1_blade").Value = locations.weaponState.GetBladeForHandle(value.ToString());
    ...
    public class DropItemLocation : ItemLocation
    {
        ...
        public DropItemLocation(ItemLocations locations, StructProperty itemDrop)
        {
            ...
            if (itemName != null)
            {
                this.priority = locations.config.items.getItemPriority(itemName);
            } else
            {
                this.priority = ItemPriority.DONT_RANDOMIZE;
            }
    ...
    public class QuestItemLocation : ItemLocation
    {
        ...
        public QuestItemLocation(ItemLocations locations, StructProperty data)
        {
            this.locations = locations;
            this.data = data;
            this.priority = locations.config.items.getItemPriority(data.getNameProperty("_item_code_name").Value);
        }
    ...
    public class EventItemLocation : ItemLocation
    {
        ...
        public EventItemLocation(ItemLocations parent, StructProperty data)
        {
            this.parent = parent;
            this.data = data;
            this.priority = parent.config.items.getItemPriority(data.getStringProperty("_param1").Value);
        }
        public FName name
        {
            set
        ...
        public string nameString
        {
            set
            {
                ...
                {
                    data.getStringProperty("_param2").Value = parent.weaponState.GetBladeForHandle(value);
                } else
                {
    ...
    public class ShopItemLocation : ItemLocation
    {
        ...
        public ShopItemLocation(ItemLocations parent, StructProperty data)
        {
            this.parent = parent;
            this.data = data;
            this.priority = parent.config.items.getItemPriority(data.getNameProperty("_item_code_name").Value);
        ...
        public string nameString {
            set
            {
                ...
                if (GameData.IsWeaponHandle(value))
                {
                    data.getNameProperty("_item_code_name2").Value = parent.weaponState.GetBladeForHandle(value);
                } else
                {
    ...
    public class GiftItemLocation : ItemLocation
    {
        ...
        public GiftItemLocation(ItemLocations parent, StructProperty data)
        {
            this.parent = parent;
            this.data = data;
            this.priority = parent.config.items.getItemPriority(data.getNameProperty("_code_name").Value);
        ...
        public string nameString
        {
            set
            {
                data.getNameProperty("_code_name").Value = value;
            }
        }
    }
    ...
    public class GiftWeaponLocation : ItemLocation
    {
        ...
        public GiftWeaponLocation(ItemLocations parent, StructProperty data)
        {
            this.parent = parent;
            this.data = data;
            this.priority = parent.config.items.getItemPriority(data.getNameProperty("_handle_code_name").Value);
        ...
        public string nameString
        {
            set
            {
                // What happens if we assign a non-weapon here?
                data.getNameProperty("_handle_code_name").Value = value;
                data.getNameProperty("_blade_code_name").Value = parent.weaponState.GetBladeForHandle(value);
            }
        }
    }
    ...
    public class ItemLocations
    {
        ...
        public WeaponMap weaponState;
        public int numLocations;

        public ItemLocations(AssetManager assets, Config config, Random random, WeaponMap weaponState)
        {
            this.assets = assets;
            this.config = config;
            this.random = random;
